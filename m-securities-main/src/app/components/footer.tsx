            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a href="https://apps.apple.com/mn/app/m-securities-mn/id6745858855"
                  ...
                  className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-black border border-white/15
                    transition-all duration-200 hover:-translate-y-0.5 hover:border-white/30">
                  <Image src="/apple-logo.svg" alt="App Store" width={20} height={20} className="w-5 h-5" style={{ filter: 'invert(1)' }} />
                ...
                <a href="https://play.google.com/store/apps/details?id=com.istock.msec&hl=en&pli=1"
                  ...
                  <div className="text-white">
                    ...
                    <div className="text-sm font-medium leading-tight mt-0.5">Play Store</div>
                  </div>
                </a>
              </div>
            </div>
